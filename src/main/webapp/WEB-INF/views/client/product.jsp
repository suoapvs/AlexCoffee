                ...
                <div class="col-xs-7 col-xs-offset-1 col-sm-7 col-sm-offset-1 col-md-7 col-md-offset-1 col-lg-7 col-lg-offset-1">
                    <div class="col-xs-3 col-md-3 col-sm-3 col-lg-3">
                        <img src="<c:url value="/resources/img/${product.photo.photoLinkShort}"/>"
                             width="185px" height="185px" alt="${product.title}">
                    </div>
                        ...
                        <c:if test="${(product.photo.photoLinkLong ne null) and (product.photo.photoLinkLong ne '')}">
                            <p>
                                <img src="<c:url value="/resources/img/${product.photo.photoLinkLong}"/>"
                                     class="hidden-xs hidden-sm" width="465px" height="465px" alt="${product.title}">
                            </p>
                        </c:if>
                        <br>
                    </div>
                                ...
                                <div class="product">
                                    <a href="<c:url value="/product/${featured_product.url}"/>"
                                       title="Перейти к ${featured_product.title}">
                                        ...
                                        <div class="text-shadow">${featured_product.title}</div>
                                        <p class="price-top">
