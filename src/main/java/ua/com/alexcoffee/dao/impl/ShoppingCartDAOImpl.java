...
/**
 * Класс реализует методы интерфейса
 * {@link ShoppingCartDAO} для работы с корзиной.
 *
...
public final class ShoppingCartDAOImpl
     ...
     *
     * @param shoppingCart Объект класса {@link ShoppingCart}
     *                     для работы с товарной
     *                     корзиной.
     */
    @Autowired
    ...
    /**
     * Возвращает список всех торговых
     * позиций в корзине.
     *
