...
/**
 * Интерфейс описывает набор методов для работы объектов класса {@link User}
 * с базой данных. Расширяет интерфейс {@link DataDAO}.
 *
...
public interface UserDAO extends DataDAO<User> {
    ...
    /**
     * Удаляет пользователя из базы даных, у которого совпадает роль с значением
     * входящего параметра.
     *
